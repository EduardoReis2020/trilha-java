...
A versão original está disponível sob os termos definidos pela autora e tem como objetivo o aprendizado sobre a interface `Map` da linguagem Java, com foco educacional e prático.
