...
A versão original está disponível sob os termos definidos pela autora e tem como objetivo o aprendizado sobre a interface `Set` da linguagem Java, com foco educacional e prático.
