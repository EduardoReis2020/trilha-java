...
> [Conhecendo Collections Java - DIO (Digital Innovation One)](https://github.com/cami-la/collections-java-api-2023/blob/master/src/main/java/list/README.md)

A versão original está disponível sob os termos definidos pela autora e tem como objetivo o aprendizado sobre a interface `List` da linguagem Java, com foco educacional e prático.
